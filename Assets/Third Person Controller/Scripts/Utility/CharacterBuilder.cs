...
namespace Opsive.ThirdPersonController
{
    ...
    public class CharacterBuilder : MonoBehaviour
    {
        ...
        private static PhysicsMaterial m_MaxFrictionMaterial;
        private static PhysicsMaterial m_FrictionlessMaterial;
        ...
        public static void BuildHumanoidCharacter(GameObject character, bool aiAgent, bool isNetworked, RigidbodyCharacterController.MovementType movementType,
                                            RuntimeAnimatorController animatorController, PhysicsMaterial maxFrictionMaterial, PhysicsMaterial frictionlessMaterial)
        {
